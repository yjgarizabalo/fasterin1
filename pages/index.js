...
import hero__yweb_02 from '../public/img/hero__yweb_02.webp'
        ...
        <main className="main">
            ...
            <section className="nosotros__yweb">
                <div className="item__nosotros">
                    <div>
                        <Image loading="lazy" className="nosotros__img" src={hero__yweb_02} alt="Desarrollo Web Barranquilla" width="400" height="250"/>
                    </div>
                    <div>
